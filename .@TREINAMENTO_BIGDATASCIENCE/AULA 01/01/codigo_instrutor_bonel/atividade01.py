...
try:
    ...
    tot_estelionato = f"{np.sum(df_estelionato['estelionato']):,.0f}".replace(',', '.')
    ...
    print(f"\nPara um total de {
          tot_estelionato} ocorrências de estelionatos, em 25% dos meses"
          " comparados, no període de Jan/2003 a Jul/2024, o número de"
          f" ocorrências foi menor que {q1} ocorrências.")
    print("Em contrapartida, em 25% dos meses neste mesmo período, o número"
          f" de ocorrências superou {q3} casos.")
    print("Em compensação, em 75% dos meses, o número de ocorrências, foi"
          f" menor que {q3} casos.")
